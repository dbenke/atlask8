...
public class MiocardioZoomActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_miocardiozoom);
        ...
        //Tab 2
        spec = host.newTabSpec("discos");
        spec.setContent(R.id.tab2);
        spec.setIndicator("discos intercalares");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("nucleos");
        spec.setContent(R.id.tab3);
        spec.setIndicator("núcleos");
        host.addTab(spec);
...
//Tab 3
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"miocardioz"+current+", ");
