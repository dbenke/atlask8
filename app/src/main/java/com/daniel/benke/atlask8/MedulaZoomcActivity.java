...
public class MedulaZoomcActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medulazoomc);
        ...
        //Tab 2
        spec = host.newTabSpec("axonio");
        spec.setContent(R.id.tab2);
        spec.setIndicator("axônio");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("nucleodaceluladaglia");
        spec.setContent(R.id.tab3);
        spec.setIndicator("núcleo da célula da glia");
        host.addTab(spec);
