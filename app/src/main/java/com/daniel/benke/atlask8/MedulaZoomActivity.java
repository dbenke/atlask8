...
public class MedulaZoomActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medulazoom);
        ...
        //Tab 2
        spec = host.newTabSpec("corpocelular");
        spec.setContent(R.id.tab2);
        spec.setIndicator("corpo celular");
        host.addTab(spec);
...
//Tab 3
        spec = host.newTabSpec("corpusculodenissl");
        spec.setContent(R.id.tab4);
        spec.setIndicator("corpúsculo de nissl");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("prolongamentocitoplasmatico");
        spec.setContent(R.id.tab5);
        spec.setIndicator("prolongamento citoplasmatico");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("celulasdaglia");
        spec.setContent(R.id.tab6);
        spec.setIndicator("células da glia");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"medulaz"+current+", ");
