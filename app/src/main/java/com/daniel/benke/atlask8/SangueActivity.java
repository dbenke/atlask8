...
public class SangueActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Tab 2
        spec = host.newTabSpec("hemacias");
        spec.setContent(R.id.tab2);
        spec.setIndicator("hemácias");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("plaquetas");
        spec.setContent(R.id.tab3);
        spec.setIndicator("plaquetas");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("neutrofilo");
        spec.setContent(R.id.tab4);
        spec.setIndicator("neutrófilo");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("eosinofilo");
        spec.setContent(R.id.tab5);
        spec.setIndicator("eosinófilo");
        host.addTab(spec);


        //Tab 3
        spec = host.newTabSpec("basofilo");
        spec.setContent(R.id.tab6);
        spec.setIndicator("basófilo");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("linfocito");
        spec.setContent(R.id.tab8);
        spec.setIndicator("linfócito");
        host.addTab(spec);


        //Tab 3
        spec = host.newTabSpec("monócito");
        spec.setContent(R.id.tab7);
        spec.setIndicator("monócito");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"sangue"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(),SangueTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
