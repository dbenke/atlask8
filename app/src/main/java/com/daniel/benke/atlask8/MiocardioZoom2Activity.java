...
public class MiocardioZoom2Activity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_miocardiozoom2);
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), MiocardioZoom2Activity.class);
        ...
        //Tab 2
        spec = host.newTabSpec("linhaz");
        spec.setContent(R.id.tab2);
        spec.setIndicator("linhas Z");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("sarcomero");
        spec.setContent(R.id.tab3);
        spec.setIndicator("sarcômero");
        host.addTab(spec);

//Tab 3
        spec = host.newTabSpec("bandaa");
        spec.setContent(R.id.tab4);
        spec.setIndicator("banda a");
        host.addTab(spec);

//Tab 3
        spec = host.newTabSpec("bandai");
        spec.setContent(R.id.tab5);
        spec.setIndicator("banda i");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"miocardiozz"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), MiocardioTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
