...
public class NervoZoomActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nervozoom);
        ...
        //Tab 2
        spec = host.newTabSpec("axonios");
        spec.setContent(R.id.tab2);
        spec.setIndicator("axônios");
        host.addTab(spec);

//Tab 2
        spec = host.newTabSpec("nucleodaceluladeschwann");
        spec.setContent(R.id.tab3);
        spec.setIndicator("núcleo da célula de schwann");
        host.addTab(spec);

//Tab 2
        spec = host.newTabSpec("perineuro");
        spec.setContent(R.id.tab4);
        spec.setIndicator("perineuro");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("enpineuro");
        spec.setContent(R.id.tab5);
        spec.setIndicator("epineuro");
        host.addTab(spec);

        spec = host.newTabSpec("endoneuro");
        spec.setContent(R.id.tab6);
        spec.setIndicator("endoneuro");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"nervoz"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), NervoTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
