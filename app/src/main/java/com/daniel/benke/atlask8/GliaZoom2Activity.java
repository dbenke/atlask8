...
public class GliaZoom2Activity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gliazoom2);
        ...
        //Tab 2
        spec = host.newTabSpec("astrocitoprotoplasmático");
        spec.setContent(R.id.tab2);
        spec.setIndicator("astrócito protoplasmático");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"gliazz"+current+", ");
