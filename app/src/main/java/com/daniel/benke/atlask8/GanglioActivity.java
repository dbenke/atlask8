...
public class GanglioActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ganglio);
...
//Tab 2
        spec = host.newTabSpec("capsula");
        spec.setContent(R.id.tab3);
        spec.setIndicator("cápsula");
        host.addTab(spec);
...
//Tab 2
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"ganglio"+current+", ");
