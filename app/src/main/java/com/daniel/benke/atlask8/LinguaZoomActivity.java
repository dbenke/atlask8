...
public class LinguaZoomActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linguazoom);
        ...
        spec.setIndicator("músculo estriado");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("glandula");
        spec.setContent(R.id.tab4);
        spec.setIndicator("glândula submandibular");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("ductos");
        spec.setContent(R.id.tab5);
        spec.setIndicator("ductos glandulares");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"linguaz"+current+", ");
