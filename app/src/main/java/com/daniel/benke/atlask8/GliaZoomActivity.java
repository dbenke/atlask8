...
public class GliaZoomActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gliazoom);
        ...
        //Tab 2
        spec = host.newTabSpec("astrocito");
        spec.setContent(R.id.tab2);
        spec.setIndicator("astrócito");
        host.addTab(spec);
        ...
        //Tab 3
        spec = host.newTabSpec("oligodendrocito");
        spec.setContent(R.id.tab4);
        spec.setIndicator("Oligodendrócito");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("pesvasculares");
        spec.setContent(R.id.tab5);
        spec.setIndicator("pés vasculares");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"gliaz"+current+", ");
