...
public class LinguaActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), LinguaZoomActivity.class);
        ...
        //Tab 2
        spec = host.newTabSpec("musculoestriado");
        spec.setContent(R.id.tab2);
        spec.setIndicator("musculo estriado");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("musculotransversal");
        spec.setContent(R.id.tab3);
        spec.setIndicator("músculo transversal");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("musculolongitudinal");
        spec.setContent(R.id.tab4);
        spec.setIndicator("músculo longitudinal");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("tecidoconjuntivo");
        spec.setContent(R.id.tab5);
        spec.setIndicator("tecido conjuntivo");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("glandula");
        spec.setContent(R.id.tab6);
        spec.setIndicator("glândula");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"lingua"+current+", ");
